...
def resnet18(**kwargs: Any) -> ResNet:
    ...
    Args:
        **kwargs: Any
    """
    return _resnet('resnet18', BasicBlock, [2, 2, 2, 2], num_channels=[1, 64, 128, 256, 512], **kwargs)
...
def resnet34_large(**kwargs: Any) -> ResNet:
    r"""ResNet-34 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_.
    ...
    Args:
        **kwargs: Any
    """
    model = _resnet('resnet34', BasicBlock, [3, 4, 6, 3], num_channels=[1, 64, 128, 256, 512], **kwargs)
    return model
...
def resnet50(**kwargs: Any) -> ResNet:
    ...
    Args:
        **kwargs: Any
    """
    model = _resnet('resnet50', Bottleneck, [3, 4, 6, 3], num_channels=[1, 64, 128, 256, 512], **kwargs)
    return model
